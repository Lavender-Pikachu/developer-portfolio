  ...
  const projects = [
    {
      ...
      name: "Dashboard App",
      image: dashboard,
      brief: "Scalable Dashboard App with CRUD operations manages all the bookings, users, guests and services."},
    {
      id: 2,
      name:"E-Commerce App",
      image: ecommerce,
      brief: "Scalable E-Commerce App with CRUD operations manages all the products, users, and orders."
    },
    {
      id: 3,
      name: "Food App",
      image: food,
      brief:"Scalable Dashboard App with CRUD operations manages all the food items, users, and orders."
    },
    {
      id: 4,
      name:" Travel App",
      image: travel,
      brief: "Scalable Travel App with CRUD operations manages all the travel bookings, users, and itineraries."
    }
  ]
  return (
    <section
        ...
        >
          {projects.map(project=>(
            ...
            >
              ...
              {["React","Tailwind CSS","Supabase","Vercel"].map((tech, index)=>{
                <span
                key={index}
                className='bg-blue-500/10 text-blue-400 py-1 px-3 rounded-full text-balance hover:bg-blue-500/20 hover:shadow-[9_2px_8px_rgba(59,130,246,0.2)] transition'
                >{tech}</span>
              })}
